...
Page({
  ...
  // 单击
    ...
    //  console.log("order: "+order)
     if(order!='')
    wx.request({
      url: 'http://123.207.149.16:8080/ssmtest/imges/sortMessage',
 ...
 onShow: function(){
  ...
  getMessage: function () {
    ...
    // 若已授权
      wx.request({
        url: 'http://123.207.149.16:8080/ssmtest/imges/getMessage',
      ...
      success(res) {
        if (res.confirm) {
          wx.request({
            ...
            url: 'http://123.207.149.16:8080/ssmtest/imges/delect',
            data: {
              openId: app.globalData.openId,
                            ...
                            wx.login({ 
                                success: res => {                                   
                                    wx.request({
                                      ...
                                      url: 'http://123.207.149.16:8080/ssmtest/wxlogin',
                                      data:{
                                        code:res.code,
                                      },
                                      header: {
